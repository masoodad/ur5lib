...
class UR5RTDE(UR5Base):
    ...
    def moveL(self, pose: Pose, speed=0.25, acceleration=0.5, blend_radius=0.0, asynchronous=False):
        """
        ...
        Args:
            ...
            asynchronous (bool): If True, move command is asynchronous; otherwise, it blocks until move completes.
        ...
        self.rtde_c.moveL(list(pose), speed, acceleration, asynchronous, blend_radius)
    ...
    def servoL(self, pose: Pose, speed=0.25, acceleration=0.5, time=0.008, lookahead_time=0.1, gain=300):
        ...
        self.rtde_c.servoL(list(pose), speed, acceleration, time, lookahead_time, gain)
